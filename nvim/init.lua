...
vim.keymap.set("n", "vw", "viw", {remap = true})
vim.keymap.set("n", "cw", "ciw", {remap = true})
vim.keymap.set("n", "rw", "riw", {remap = true})
vim.keymap.set("n", "dw", "diw", {remap = true})
vim.keymap.set("n", "yw", "yiw", {remap = true})
